...
class NextPayGateway extends BaseGateway implements ShaparakFeature {

	protected string $name = 'نکست پی';

	protected string $description = 'nextpay.org';

	protected string $url = 'https://l.nabik.net/nextpay';

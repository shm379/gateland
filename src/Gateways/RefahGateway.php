...
class RefahGateway extends BaseGateway implements ShaparakFeature {

	protected string $name = 'بانک رفاه';

	protected string $description = 'refah-bank.ir';

	protected string $url = 'https://l.nabik.net/refah';

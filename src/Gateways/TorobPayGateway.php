...
class TorobPayGateway extends BaseGateway implements BNPLFeature, InquiryFeature {

	protected string $name = 'ترب پی';

	protected string $description = 'torobpay.com';

	protected string $url = 'https://l.nabik.net/torobpay';
